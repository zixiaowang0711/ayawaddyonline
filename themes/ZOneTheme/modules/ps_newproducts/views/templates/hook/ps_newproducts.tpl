...
<section class="new-products">
  <div class="block clearfix">
    ...
    <div class="title-block d-flex flex-wrap">
      <span>{l s='New products' d='Modules.Newproducts.Shop'}</span>
      <span class="view-all-link">
        <a href="{$allNewProductsLink}">{l s='All new products' d='Modules.Newproducts.Shop'} <i class="material-icons">&#xE8E4;</i></a>
      </span>
    </div>
