  ...
  <div class="order-items hidden-lg-up box">
    {foreach from=$order.products item=product}
      <div class="order-item">
        <div class="row">
          <div class="col-12 col-sm-5 desc">
          ...
          <div class="col-12 col-sm-7 qty">
            <div class="row">
              ...
              <div class="col-5 price-total text-right">
                {$product.total}
              </div>
            </div>
          </div>
    ...
    <div class="order-totals order-item">
      ...
      <div class="order-total row">
        ...
        <div class="col-4 text-right price price-total">{$order.totals.total.value}</div>
      </div>
    </div>
  </div>
{/block}
