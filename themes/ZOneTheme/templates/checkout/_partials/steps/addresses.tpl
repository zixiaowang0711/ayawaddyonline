  ...
  <div class="js-address-form">
    ...
    >
      <section class="shipping-address">
        {if !$use_same_address}
          <h5>{l s='Shipping Address' d='Shop.Theme.Checkout'}</h5>
        {/if}
        ...
        {if $show_delivery_address_form}
          <div id="delivery-address" class="shadow-box">
        ...
        {elseif $customer.addresses|count > 0}
          ...
          <p class="add-address">
            <a class="btn btn-secondary" href="{$new_address_delivery_url}"><i class="material-icons">&#xE145;</i>{l s='add new address' d='Shop.Theme.Actions'}</a>
          </p>

          {if $use_same_address && !$cart.is_virtual}
            <p class="billing-address">
              <a data-link-action="different-invoice-address" href="{$use_different_address_url}" class="btn btn-teriary">
      ...
      {if !$use_same_address}
        <section class="invoice-address">
          ...
          {if $show_invoice_address_form}
            <div id="invoice-address" class="shadow-box">
              {render file                      = 'checkout/_partials/address-form.tpl'
                      ui                        = $address_form
                      use_same_address          = $use_same_address
                      type                      = "invoice"
          ...
          {else}
            ...
            <p class="add-address">
              <a class="btn btn-secondary" href="{$new_address_invoice_url}"><i class="material-icons">&#xE145;</i>{l s='add new address' d='Shop.Theme.Actions'}</a>
            </p>
          {/if}
        </section>
      {/if}
