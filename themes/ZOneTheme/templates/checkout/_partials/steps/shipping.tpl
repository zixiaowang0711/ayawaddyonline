...
{block name='step_content'}
  ...
  <div class="delivery-options-list light-box-bg pt-0">
                    ...
                    <div class="row">
                      <div class="col-md-5 col-12">
                        <div class="row">
                          ...
                          {/if}
                          <div class="col-9 {if !$carrier.logo}offset-3{/if}">
                            <span class="carrier-name">{$carrier.name}</span>
                          </div>
                        </div>
                      </div>
                      <div class="col-md-4 offset-md-0 offset-3 col-9">
                        <span class="carrier-delay">{$carrier.delay}</span>
                      </div>
                      <div class="col-md-3 offset-md-0 offset-3 col-9">
                        <span class="carrier-price">{$carrier.price}</span>
                      </div>
                    </div>
                  </label>

                  <div class="col-12 carrier-extra-content"{if $delivery_option != $carrier_id} style="display:none;"{/if}>
