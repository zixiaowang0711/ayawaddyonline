...
{block name="td_content"}
	...
	{elseif isset($params.type) && $params.type == 'zid_homeblock'}
		#{$tr.id_zhomeblock|escape:'htmlall':'UTF-8'}
	{elseif isset($params.type) && $params.type == 'zid_hometab'}
		#{$tr.id_zhometab|escape:'htmlall':'UTF-8'}
	{elseif isset($params.type) && $params.type == 'zblocktype'}
