	...
	$(document).ready(function(){
		$('#filter-by-supplier').click(function() {
			if ($(this).is(':checked')) {
				...
				location.href = 'index.php?controller=AdminErpProductOrder16&token={$token|escape:'html':'UTF-8'}&reset_filter_supplier=1';
			}
		});
	});
</script>
				...
				<div class="row">
					<div class="col-lg-4" style=" ">
						...
						<span class="pull-left">
							...
							<button type="submit" id="submitFilterButton{$list_id|escape:'htmlall':'UTF-8'}" name="submitFilter" class="btn btn-default" data-list-id="{$list_id|escape:'html'}">
