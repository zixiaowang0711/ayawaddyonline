...
private $digitArray = array(0=>"00110",1=>"10001",2=>"01001",3=>"11000",4=>"00101",5=>"10100",6=>"01100",7=>"00011",8=>"10010",9=>"01010");
	public function __construct($value,$into=1, $filename = 'barcode.png', $width_bar=300, $height_bar=65, $show_codebar=false) { 	 
  ...
  if ($show_codebar) {
	...
	public function put_img($image,$file='test.png', $value){
		if($this->into){
                    imagepng($image, _PS_MODULE_DIR_.'wic_erp/views/img/barcode/barcode_'.$value.'.png');
		} else {
