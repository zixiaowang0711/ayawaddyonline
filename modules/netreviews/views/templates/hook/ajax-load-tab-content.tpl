...
{foreach from=$reviews key=k_review item=review}
	...
	<div class="reviewAV" id="review{$p}_{$pages_nb}">
		<ul class="reviewInfosAV">
			...
			<li class="rateAV"><img src="{$modules_dir|escape:'htmlall':'UTF-8'}netreviews/views/img/etoile{$review['rate']|escape:'htmlall':'UTF-8'}.png" width="80" height="15" alt="" /> {$review['rate']|escape:'htmlall':'UTF-8'}/5</li>
		</ul>
