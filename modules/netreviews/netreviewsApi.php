         ...
         $num_state = $order['state_order'];
            ...
            if (!empty($allowed_products) && $allowed_products == 'yes') {
                ...
                foreach ($products_in_order as $element) {
                    if ( !in_array($element['product_id'], $product_exception)) {// && Product::idIsOnCategoryId($element['product_id'],$listofcategoriesaccepted)
                ...
                if (isset($arra_column[11]) && $arra_column[11] > 0) {
                    ...
                    if (($arra_column[11] * 3 + 12) == $count_column) {
                        ...
                        Db::getInstance()->Execute('REPLACE INTO '._DB_PREFIX_.'av_products_reviews
                                                    (id_product_av, ref_product, rate, review, horodate, customer_name,
                                                     discussion,iso_lang,id_shop)
