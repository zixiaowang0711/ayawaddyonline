 ...
 *
 */
class SearchByShortDescription extends SearchAbstract
{
    ...
    public function search()
    {
        ...
        $product_query->where('pl.`description_short` LIKE \'%'.pSQL($this->keyword).'%\'');
        ...
        $product_query->orderBy('pl.`description_short` ASC');
