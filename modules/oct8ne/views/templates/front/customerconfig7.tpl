...
<div id="content-wrapper">
    ...
    <h1>Oct8ne client side configuration</h1>
    <br>
    <form id="module_form_1" class="defaultForm form-horizontal" action="{$SUBMIT}" method="post" enctype="multipart/form-data" novalidate="">
        ...
        <div class="panel" style="border: none">
            ...
            <button type="submit" value="1" name="oct_options_changed" class="btn btn-success pull-right"> <i class="icon-save"></i> {l s='Save' mod='oct8ne'}</button>
        </div>
    ...
    <form class="defaultForm form-horizontal" action="{$SUBMIT}" enctype="multipart/form-data" style="margin-top: 70px" method="post">
        ...
        <div class="panel" style="border: none">
            ...
            <button type="submit" value="1" id="module_form_submit_btn_1" name="oct_search_engine_changed" class="btn btn-success pull-right">
