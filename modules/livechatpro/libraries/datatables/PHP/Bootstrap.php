...
/*require( dirname(__FILE__).'/Ext/Ext.php' );

require( dirname(__FILE__).'/Database/Database.php' );
require( dirname(__FILE__).'/Database/Result.php' );
require( dirname(__FILE__).'/Database/Query.php' );
require( dirname(__FILE__).'/Database/Driver/Mysql/Result.php' );
require( dirname(__FILE__).'/Database/Driver/Mysql/Query.php' );

require( dirname(__FILE__).'/Editor/Editor.php' );
require( dirname(__FILE__).'/Editor/Join.php' );
require( dirname(__FILE__).'/Editor/Mjoin.php' );
require( dirname(__FILE__).'/Editor/Field.php' );
require( dirname(__FILE__).'/Editor/Format.php' );
require( dirname(__FILE__).'/Editor/Validate.php' );
require( dirname(__FILE__).'/Editor/Upload.php' );*/
