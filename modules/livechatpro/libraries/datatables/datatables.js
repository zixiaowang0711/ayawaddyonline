...
KeyTable.prototype = {
	...
	_focus: function ( row, column )
	{
		...
		this._scroll( $(window), $(document), node, 'offset' );
...
RowReorder.prototype = {
	...
	_mouseDown: function ( e, target )
	{
		...
		if ( $(window).width() === $(document).width() ) {
			$(document).addClass( 'dt-rowReorder-noOverflow' );
		}
	},
	...
	_mouseUp: function ( e )
	{
		...
		$(document).removeClass( 'dt-rowReorder-noOverflow' );
