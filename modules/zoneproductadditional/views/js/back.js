...
$( document ).ready(function() {
	$('#scope_selectbox').change(function() {
		if (this.value == 'Some Categories')
			$('#productBox').closest('div.form-group').slideUp(400, function(){
				$('#categoryBox').closest('div.form-group').slideDown();
			});
		else if(this.value == 'Some Products')
			$('#categoryBox').closest('div.form-group').slideUp(400, function(){
	...
	aInitTableDnD('zoneproductadditional', 'zoneproductadditional');
});